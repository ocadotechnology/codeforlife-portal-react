...
import { BaseSection, PageBanner, TwoColumnSection } from 'pages/aboutUs/AboutUs';
...
const CodingClubs: React.FC = () => {
  ...
  const primaryCodingClubLeftChild = <>
  ...
  return (
    <BasePage>
      ...
      <BaseSection containerProps={{ bgcolor: theme.palette.info.main }}>
        <TwoColumnSection left={primaryCodingClubLeftChild} right={primaryCodingClubRightChild} />
      </BaseSection>

      <BaseSection>
        <TwoColumnSection left={pythonCodingClubLeftChild} right={pythonCodingClubRightChild} />
      </BaseSection>
