...
const ChildrenIntro: React.FC = () => {
  return (
    <Grid container columnSpacing={3} mb={5}>
      <Grid xs={12} md={6}>
      ...
      <Grid xs={12} md={6}>
        ...
        <Typography fontWeight='bold'>
          You should use the <Link onClick={() => { useFreshworksWidget('open'); }} className='body'>Contact Us form</Link> if you need help or advice on how to use the site. Please be aware that we will never ask for personal information other than what is required to identify your account and answer your questions, and we will never ask for your password.
        </Typography>
      </Grid>
    </Grid >
  );
