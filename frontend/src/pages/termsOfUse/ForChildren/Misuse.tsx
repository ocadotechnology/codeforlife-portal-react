...
const Misuse: React.FC = () => {
  ...
  return (
    <Stack>
      ...
      <Typography>
        We also aim to provide you with the best service we can, but we can’t promise that the Code for Life site, or our games, platforms and services will always be fault, virus or mistake-free. If you notice a problem or fault, please let us know using the <Link href='' className='body'>contact us form</Link> and we will do all we can to correct it as quickly as we can.
      </Typography>
      <Typography>
